    ...
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-brand-primary/30">
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-6 py-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <button onClick={() => setView('terms')} className="text-[10px] font-bold tracking-widest text-zinc-600 hover:text-white uppercase transition-colors">
            Terms & Conditions
          </button>
        </div>
...
const Terms = ({ onBack }) => {
  return (
    <div className="max-w-4xl mx-auto py-20 px-6 animate-in fade-in duration-700">
      <div className="flex items-center justify-between mb-12">
        <button onClick={onBack} className="text-[10px] font-black text-zinc-500 uppercase tracking-widest hover:text-white transition-colors">← Back</button>
        <h2 className="text-xl font-bold tracking-tighter uppercase italic text-white">Terms & <span className="text-brand-primary">Conditions</span></h2>
      </div>

      <div className="prose prose-invert max-w-none space-y-12 text-zinc-400 font-light leading-relaxed">
        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">1. Introduction</h3>
          <p>
            Welcome to Faceless Method. These Terms and Conditions govern your use of our website and the purchase of our digital product, the "Faceless Creator Bundle." By accessing our site or purchasing our product, you agree to be bound by these terms. This service is operated by Faceless Method ("we," "us," or "our").
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">2. Nature of Product</h3>
          <p>
            The Faceless Creator Bundle is a digital-only product. No physical goods will be shipped. The product consists of content strategy materials, including TikTok/Instagram ideas, video scripts, and a 30-day content plan.
          </p>
          <p className="mt-4">
            <strong>AI-Generated Content:</strong> You acknowledge that the content provided is generated by artificial intelligence. This content is provided for informational and educational purposes only.
          </p>
          <p className="mt-4">
            <strong>No Guarantees:</strong> We provide no guarantee of specific results, including but not limited to follower growth, engagement, income, or business success.
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">3. No Financial Guarantees</h3>
          <p>
            Success in digital content creation depends on numerous factors beyond our control. We do not promise income, virality, or any specific level of success. Results vary significantly between users based on their effort, niche, and platform algorithms.
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">4. User Responsibility</h3>
          <p>
            You are solely responsible for how you use the content provided. While our AI generates strategies and scripts, you must review, edit, and fact-check all outputs before posting or using them commercially. You are responsible for ensuring your content complies with the terms of service of the platforms you post on (e.g., TikTok, Instagram, YouTube).
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">5. Payments and Delivery</h3>
          <p>
            Payments are processed via Stan Store. Once a purchase is confirmed, delivery of the digital product is automated via email to the address provided at checkout. All sales are final.
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">6. Intellectual Property</h3>
          <p>
            <strong>Usage Rights:</strong> Upon purchase, you are granted a non-exclusive license to use the delivered content for your own personal or commercial social media accounts.
          </p>
          <p className="mt-4">
            <strong>Ownership:</strong> Faceless Method retains all ownership of the brand, the underlying system, the platform code, and the templates.
          </p>
          <p className="mt-4 text-white font-bold">
            Restrictions: You may not resell, redistribute, repackage, or claim ownership of the Faceless Method system, templates, or scripts as your own product for resale.
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">7. Refund Policy</h3>
          <p>
            Due to the nature of digital products and instant delivery, we do not offer refunds once the product has been delivered. If you experience a technical issue preventing access to your bundle, please contact support for assistance.
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">8. Limitation of Liability</h3>
          <p>
            Faceless Method and its owners shall not be held liable for any business outcomes, losses, damages, or legal issues resulting from the use of our product or the implementation of our suggested strategies. You use this product at your own risk.
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">9. Privacy</h3>
          <p>
            We collect your email and form responses solely to deliver the product, provide support, and improve our services. Your data is handled in accordance with our privacy standards and is never sold to third parties.
          </p>
        </section>

        <section>
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">10. Governing Law</h3>
          <p>
            These terms are governed by and construed in accordance with the laws of the United States. Any disputes shall be handled in the jurisdiction of North Carolina, USA.
          </p>
        </section>

        <section className="pt-12 border-t border-white/5">
          <h3 className="text-white font-bold uppercase tracking-widest text-sm mb-4">11. Contact Information</h3>
          <p>
            For support or inquiries regarding these terms, please contact: <br />
            <span className="text-brand-primary font-bold">Facelessos.app@gmail.com</span>
          </p>
        </section>
      </div>
    </div>
